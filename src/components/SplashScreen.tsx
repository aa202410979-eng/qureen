  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-between px-6 pt-12 opacity-20">
        {[...Array(7)].map((_, i) => (
          <div key={i} className="text-amber-300 text-2xl">✦</div>
        ))}
      </div>
      ...
      <div className="flex flex-col items-center gap-6 px-8">
        ...
        <div className="relative">
          <div className="absolute inset-0 rounded-full"
            style={{ background: 'radial-gradient(circle, rgba(212,180,67,0.3) 0%, transparent 70%)', transform: 'scale(1.8)' }}
          />
      ...
      <div className="w-full px-8 pb-14">
        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
          <div className="h-full rounded-full"
            style={{ width: `${progress}%`, background: 'linear-gradient(90deg, #d4b483, #f0d080)', transition: 'width 0.05s linear' }}
          />
        </div>
